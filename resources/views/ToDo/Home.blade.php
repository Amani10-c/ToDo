...
<div class="container">
    <div class="row">
       ...
       <div class="card">
            <h5 class="card-header">{{$List1->user_id}}</h5>
            <div class="card-body">
             <h5 class="card-title">{{$List1->date}}</h5>
              <p class="card-text">{{$List1->title}}</p>
              <p class="card-text">{{$List1->description}}</p>
              
              <button class="btn btn-primary" id="myButton">Done</button>
